...
(function (alm) {
    ...
    (function (io) {
        ...
        })(LoggerLevel = io.LoggerLevel || (io.LoggerLevel = {}));
        ...
        io.ConsoleLogging = ConsoleLogging;
        ...
        io.ParallelLogging = ParallelLogging;
        var Logger = (function () {
            function Logger() {
            }
    ...
    (function (state) {
        var Switcher = (function (_super) {
            ...
            Switcher.prototype.dispatchPagerEvent = function (eventType, callback, useTransition) {
                ...
                var event = new state.SwitcherEvent(eventType, this, this.newItemIndex, this.oldItemIndex, this.newItemId, this.oldItemId, useTransition);
                if (callback) {
                    callback(event);
                }
            ...
            Switcher.prototype.getNewItemIndex = function () { return this.newItemIndex; };
            ...
            Switcher.prototype.getNewItemId = function () { return this.newItemId; };
...
(function (alm) {
    ...
    (function (state) {
        var SwitcherEvent = (function (_super) {
            ...
            function SwitcherEvent(eventType, eventTarget, newItemIndex, oldItemIndex, newItemId, oldItemId, useTransition) {
            ...
            SwitcherEvent.prototype.clone = function () {
                return new SwitcherEvent(this.getType(), this.getTarget(), this.newItemIndex, this.oldItemIndex, this.newItemId, this.oldItemId, this.useTransition);
            };
...
(function (alm) {
    ...
    (function (io) {
        ...
        var FileLoader = (function (_super) {
            ...
            function FileLoader() {
                var _this = _super.call(this) || this;
                _this.fileLoadCompleteHandler = function (query, content) {
                ...
                _this.fileLoadErrorHandler = function (query, message) {
                    --_this.currentThreadCount;
                    query.isLoading = false;
                    query.isLoadComplete = true;
            ...
            FileLoader.prototype.next = function () {
                ...
                if (this.currentCount > 0) {
                    this.dispatchEvent(new io.FileLoaderEvent(io.FileLoaderEvent.PROGRESS, this, this.currentCount / this.totalCount, this.currentCount, this.totalCount));
                }
                var _loop_1 = function () {
                    if (this_1.loadingQueryIndex + 1 < this_1.totalCount) {
                        ...
                        this_1.dispatchEvent(new io.FileLoaderEvent(io.FileLoaderEvent.COMPLETE, this_1, this_1.currentCount / this_1.totalCount, this_1.currentCount, this_1.totalCount));
                        return "break";
                    }
                };
                var this_1 = this;
...
(function (alm) {
    var io;
    (function (io) {
        var FileLoaderEvent = (function (_super) {
            __extends(FileLoaderEvent, _super);
            function FileLoaderEvent(eventType, eventTarget, progress, loadedCount, totalCount, content) {
                if (eventTarget === void 0) { eventTarget = null; }
...
(function (scn) {
    var Logger = alm.io.Logger;
    var LoggerLevel = alm.io.LoggerLevel;
    var EventDispatcher = alm.event.EventDispatcher;
