...
(function (alm) {
    ...
    (function (util) {
        ...
        var NullLogging = (function () {
            ...
            NullLogging.prototype.verbose = function (messages) {
            };
            NullLogging.prototype.info = function (messages) {
            };
            NullLogging.prototype.warn = function (messages) {
            };
            NullLogging.prototype.error = function (messages) {
            };
            return NullLogging;
        }());
        ...
        var DOMLogging = (function () {
            ...
            DOMLogging.prototype.verbose = function (messages) {
                this.print("[Verbose] ", messages);
            };
            DOMLogging.prototype.info = function (messages) {
                this.print("[Info   ] ", messages);
            };
            DOMLogging.prototype.warn = function (messages) {
                this.print("[Warn   ] ", messages);
            };
            DOMLogging.prototype.error = function (messages) {
                this.print("[Error  ] ", messages);
            };
            DOMLogging.prototype.print = function (prefix, messages) {
                var line = messages.join(", ") + "\n";
                if (this.html) {
        ...
        var ParallelLogging = (function () {
            ...
            ParallelLogging.prototype.verbose = function (messages) {
                var n = this.loggers.length;
                for (var i = 0; i < n; ++i) {
                    this.loggers[i].verbose.apply(this, messages);
                }
            };
            ParallelLogging.prototype.info = function (messages) {
                var n = this.loggers.length;
                for (var i = 0; i < n; ++i) {
                    this.loggers[i].info.apply(this, messages);
                }
            };
            ParallelLogging.prototype.warn = function (messages) {
                var n = this.loggers.length;
                for (var i = 0; i < n; ++i) {
                    this.loggers[i].warn.apply(this, messages);
                }
            };
            ParallelLogging.prototype.error = function (messages) {
                var n = this.loggers.length;
                for (var i = 0; i < n; ++i) {
        ...
        var Logger = (function () {
            ...
            Logger.verbose = function () {
                ...
                if (Logger.level <= LoggerLevel.Verbose)
                    Logger.logger.verbose(messages);
            };
    ...
    (function (util) {
        var Pager = (function (_super) {
            ...
            Pager.prototype.dispatchPagerEvent = function (eventType, callback, useTransition) {
                var oldItemId = this.oldItemIndex != -1 ? this.itemIds[this.oldItemIndex] : null;
                var newItemId = this.newItemIndex != -1 ? this.itemIds[this.newItemIndex] : null;
                var event = new util.PagerEvent(eventType, this, this.newItemIndex, this.oldItemIndex, this.newItemId, this.newItemId, useTransition);
                if (callback) {
                    callback(event);
                }
...
(function (alm) {
    ...
    (function (loader_1) {
        ...
        var AssetLoader = (function () {
            ...
            AssetLoader.prototype.next = function () {
                ...
                if (this.currentCount > 0) {
                    this.eventDispatcher.dispatchEvent(new loader_1.AssetLoaderEvent(loader_1.AssetLoaderEvent.PROGRESS, this, this.currentCount / this.totalCount, this.currentCount, this.totalCount));
                }
                if (this.currentCount < this.totalCount) {
                    ...
                    switch (query_1.type) {
                        ...
                        case "THREE.Texture":
                            ...
                            var texture = loader_2.load(url, function (texture) {
                                query_1.isLoading = false;
                                query_1.isLoadComplete = true;
                    ...
                    this.loadingQueries = [];
                    this.loadingQueryIndex = -1;
                    this.eventDispatcher.dispatchEvent(new loader_1.AssetLoaderEvent(loader_1.AssetLoaderEvent.COMPLETE, this, this.currentCount / this.totalCount, this.currentCount, this.totalCount));
                }
            };
            AssetLoader.prototype.addLoadUpdateListener = function (listener) {
                this.eventDispatcher.addEventListener(loader_1.AssetLoaderEvent.PROGRESS, listener);
            };
            AssetLoader.prototype.removeLoadUpdateListener = function (listener) {
                this.eventDispatcher.removeEventListener(loader_1.AssetLoaderEvent.PROGRESS, listener);
            };
            AssetLoader.prototype.addLoadCompleteListener = function (listener) {
                this.eventDispatcher.addEventListener(loader_1.AssetLoaderEvent.COMPLETE, listener);
            };
            AssetLoader.prototype.removeLoadCompleteListener = function (listener) {
                this.eventDispatcher.removeEventListener(loader_1.AssetLoaderEvent.COMPLETE, listener);
            };
        ...
        loader_1.AssetLoader = AssetLoader;
        ...
        loader_1.LoaderQuery = LoaderQuery;
...
(function (alm) {
    ...
    (function (view) {
        var ButtonBehavior = (function () {
            function ButtonBehavior(target, hitArea) {
...
(function (alm) {
    ...
    (function (browser) {
        ...
        var WindowWatcherEvent = (function (_super) {
            ...
            function WindowWatcherEvent(eventType, eventTarget, jqueryEvent, scrollTop, scrollBottom, windowWidth, windowHeight) {
                if (eventTarget === void 0) { eventTarget = null; }
                if (jqueryEvent === void 0) { jqueryEvent = null; }
