        ...
        var ButtonBehavior = (function () {
            function ButtonBehavior(target, hitArea, isHoverCursorEnabled, isPreventDefaultEnabled, isStopPropagationEnabled) {
                ...
                this.mouseOverHandler = function (event) {
                    ...
                    if (_this.isHoverCursorEnabled) {
                        _this.defaultMouseCursor = _this.hitArea.style.cursor;
                        _this.hitArea.style.cursor = 'pointer';
                    }
                    _this.over();
                };
                this.mouseOutHandler = function (event) {
                    ...
                    if (_this.isStopPropagationEnabled)
                        event.stopPropagation();
                    if (_this.isHoverCursorEnabled) {
                        _this.hitArea.style.cursor = _this.defaultMouseCursor != '' ? _this.defaultMouseCursor : 'pointer';
                    }
                    _this.out();
                };
    ...
    (function (browser) {
        var WindowWatcher = (function () {
            ...
            WindowWatcher.start = function () {
                ...
                if (browser.DeviceInfo.getIsDesktop()) {
