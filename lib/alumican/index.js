    ...
    (function (state) {
        var Switcher = (function (_super) {
            ...
            Switcher.prototype.dispatchPagerEvent = function (eventType, callback, useTransition) {
                var event = new state.SwitcherEvent(eventType, this, this.currentItemIndex, this.oldItemIndex, this.currentItemId, this.prevItemId, useTransition);
                if (callback) {
                    callback(event);
                }
            ...
            Switcher.prototype.getPrevItemIndex = function () { return this.oldItemIndex; };
            ...
            Switcher.prototype.getPrevItemId = function () { return this.prevItemId; };
...
(function (alm) {
    ...
    (function (state) {
        var SwitcherEvent = (function (_super) {
            ...
            function SwitcherEvent(eventType, eventTarget, currentItemIndex, prevItemIndex, currentItemId, prevItemId, useTransition) {
                var _this = _super.call(this, eventType, eventTarget) || this;
                _this.currentItemIndex = currentItemIndex;
                _this.prevItemIndex = prevItemIndex;
                _this.currentItemId = currentItemId;
                _this.prevItemId = prevItemId;
                _this.useTransition = useTransition;
                return _this;
            }
            SwitcherEvent.prototype.clone = function () {
                return new SwitcherEvent(this.getType(), this.getTarget(), this.currentItemIndex, this.prevItemIndex, this.currentItemId, this.prevItemId, this.useTransition);
            };
