...
(function (alm) {
    ...
    (function (browser) {
        var QueryString = (function () {
            ...
            QueryString.getReplacedQueryStringUrl = function (url, key, value) {
            ...
            QueryString.replaceQueryString = function (key, value) {
                var url = QueryString.getReplacedQueryStringUrl(window.location.href, key, value);
                var state = url.match(/^https?:\/{2,}.*?(\/.*)/)[1];
...
(function (cmd) {
    var CommandList = (function (_super) {
        ...
        CommandList.prototype.insertCommand = function () {
            ...
            this.insertCommandAt.apply(this, __spreadArray([0], commands, false));
        };
        ...
        CommandList.prototype.insertCommandArrayAt = function (index, commands) {
            this.insertCommandAt.apply(this, __spreadArray([index], commands, false));
        };
...
(function (cmd) {
    var Serial = (function (_super) {
        ...
        Serial.prototype.insertCommand = function () {
            ...
            _super.prototype.insertCommandAt.apply(this, __spreadArray([this.position + 1], commands, false));
        };
...
(function (alm) {
    ...
    (function (util) {
        var Num = (function () {
            ...
            Num.randomAbs = function (min, max) {
                if (min === void 0) { min = 0; }
                if (max === void 0) { max = 1; }
                return Num.random(min, max) * Num.randomSign();
            };
            Num.randomSign = function () {
...
(function (alm) {
    ...
    (function (util) {
        ...
        var Dom = (function () {
            ...
            Dom.instantiate = function (templateId, removeId) {
                if (removeId === void 0) { removeId = true; }
            ...
            Dom.addPointerMoveListener = function (target, listener) {
            ...
            Dom.addPointerEnterListener = function (target, listener) {
                target.addEventListener('pointerenter', listener);
            };
            Dom.addPointerLeaveListener = function (target, listener) {
                target.addEventListener('pointerleave', listener);
            };
            Dom.addPointerOverListener = function (target, listener) {
                target.addEventListener('pointerover', listener);
            };
            Dom.addPointerOutListener = function (target, listener) {
                target.addEventListener('pointerout', listener);
            };
            Dom.removePointerDownListener = function (target, listener) {
                target.removeEventListener('pointerdown', listener);
            };
            Dom.removePointerMoveListener = function (target, listener) {
            ...
            Dom.removePointerEnterListener = function (target, listener) {
                target.removeEventListener('pointerenter', listener);
            };
            Dom.removePointerLeaveListener = function (target, listener) {
                target.removeEventListener('pointerleave', listener);
            };
            Dom.removePointerOverListener = function (target, listener) {
                target.removeEventListener('pointerover', listener);
            };
            Dom.removePointerOutListener = function (target, listener) {
                target.removeEventListener('pointerout', listener);
            };
            Dom.addRootClass = function (value) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                Dom.root.classList.add(value);
            };
            Dom.removeRootClass = function (value) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                Dom.root.classList.remove(value);
            };
            Dom.addRootAttribute = function (key, value) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                Dom.root.setAttribute(key, value);
            };
            Dom.removeRootAttribute = function (key, value) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                Dom.root.removeAttribute(key);
            };
            Dom.getRootCss = function (property) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                return Dom.root.style.getPropertyValue(property);
            };
            Dom.setRootCss = function (property, value) {
                if (Dom.root === null) {
                    Dom.root = document.documentElement;
                }
                Dom.root.style.setProperty(property, value);
            };
            Dom.scrollTo = function (scrollTop, useTransition) {
                if (useTransition === void 0) { useTransition = true; }
                Dom.scrollTween = util.Cmd.stop(Dom.scrollTween);
                if (useTransition) {
                    Dom.scrollTween = new cmd.Tween(Dom, { scrollPosition: scrollTop }, null, 1000, Easing.easeOutQuart, null, function () {
            ...
            Dom.applyScrollPosition = function () {
                window.scroll(0, Dom.scrollPosition);
            };
            Dom.setupSmoothAnchorLink = function () {
            ...
            Dom.setAnchorLinkAction = function (tag) {
            ...
            Dom.anchorLinkClickHandler = function (event) {
                var tag = event.currentTarget;
                var targetId = tag.getAttribute('data-smooth-anchor-target');
                var target = document.getElementById(targetId);
                var targetScrollPosition = window.pageYOffset + target.getBoundingClientRect().top;
...
(function (alm) {
    ...
    (function (util) {
        ...
        var Easing = alm.math.Easing;
        var CssVar = (function () {
            function CssVar(property, defaultValue, suffix) {
                if (defaultValue === void 0) { defaultValue = null; }
                if (suffix === void 0) { suffix = null; }
                this.reset(property, defaultValue, suffix);
            }
            CssVar.prototype.reset = function (property, value, suffix) {
                ...
                if ((this.value === null) || (this.suffix === null)) {
                    var result = CssVar.numberPattern.exec(Dom.getRootCss(this.property));
            ...
            CssVar.prototype.getProperty = function () {
                return this.property;
            };
            CssVar.prototype.setProperty = function (property) {
                this.cancelAnimation();
            ...
            CssVar.prototype.getValue = function () {
                return this.value;
            };
            CssVar.prototype.setValue = function (value) {
                this.cancelAnimation();
                if (this.value !== value) {
                    this.value = value;
                    this.apply();
            ...
            CssVar.prototype.getSuffix = function () {
                return this.suffix;
            };
            CssVar.prototype.setSuffix = function (suffix) {
                this.cancelAnimation();
            ...
            CssVar.prototype.animate = function (to, from, duration, easing, execute) {
                var _this = this;
                if (duration === void 0) { duration = 1000; }
                if (easing === void 0) { easing = Easing.linear; }
                if (execute === void 0) { execute = true; }
                this.cancelAnimation();
                this.tween = new cmd.Tween(this, { value: to }, from !== null ? { value: from } : null, duration, easing, null, function () {
                    _this.apply();
                }, function () {
                    _this.tween = null;
                });
            ...
            CssVar.prototype.cancelAnimation = function () {
                if (this.tween) {
                    this.tween = Cmd.stop(this.tween);
                }
            };
            CssVar.prototype.animateTo = function (to, duration, easing, execute) {
                if (duration === void 0) { duration = 1000; }
                if (easing === void 0) { easing = Easing.linear; }
                if (execute === void 0) { execute = true; }
                return this.animate(to, null, duration, easing, execute);
            };
            CssVar.prototype.apply = function () {
...
(function (alm) {
    ...
    (function (math) {
        var BinarySearch = (function () {
            ...
            BinarySearch.prototype.setList = function (list) {
                this.list = list;
            };
            BinarySearch.prototype.searchNearest = function (value) {
                var lowIndex = 0;
                var highIndex = this.list.length - 1;
                var midIndex;
                var estimated;
            ...
            BinarySearch.prototype.leapNearest = function (value) {
                var nearestIndex = this.searchNearest(value);
                var nearestValue = this.list[nearestIndex];
                var lowIndex;
                var lowValue;
                var highIndex;
                var highValue;
...
(function (alm) {
    ...
    (function (math) {
        var MersenneTwister = (function () {
            ...
            ;
            MersenneTwister.prototype.getInt = function () {
                var min, sup;
            ...
            ;
            MersenneTwister.prototype.getFloat = function () {
...
(function (alm) {
    var io;
    (function (io) {
        var ImageFileHandler = (function () {
            function ImageFileHandler(crossOrigin) {
                if (crossOrigin === void 0) { crossOrigin = null; }
                this.crossOrigin = crossOrigin;
            }
            ImageFileHandler.prototype.getType = function () {
                return ImageFileHandler.TYPE;
            };
            ImageFileHandler.prototype.load = function (url, onComplete, onError) {
                var image = new Image();
        ...
        var DeviceInfo = (function () {
            ...
            DeviceInfo.initialize = function () {
                ...
                try {
                    ...
                    if (this.isChrome) {
                        this.langFull = (navigator_1.languages[0] || navigator_1['browserLanguage'] || navigator_1.language || navigator_1['userLanguage']);
                    }
                    else {
                        this.langFull = (navigator_1['browserLanguage'] || navigator_1.language || navigator_1['userLanguage']);
                    }
            ...
            DeviceInfo.getLang = function () {
                this.initialize();
                return this.lang;
            };
            DeviceInfo.getLangFull = function () {
                this.initialize();
            ...
            DeviceInfo.getIsWebGlEnabled = function () {
                this.initialize();
...
(function (alm) {
    ...
    (function (browser) {
        var SessionStorage = (function () {
            ...
            SessionStorage.load = function (key, defaultValue) {
                if (defaultValue === void 0) { defaultValue = null; }
                if (!SessionStorage.isAvailable())
                    return defaultValue;
...
(function (scn) {
    ...
    var Scene = (function (_super) {
        ...
        Scene.prototype.getChildrenByName = function () {
        ...
        Scene.prototype.getTransferInfo = function () {
            return this.transferInfo || null;
        };
        Scene.prototype.gotoScene = function (path, message) {
...
(function (scn) {
    ...
    var SceneEvent = (function (_super) {
        ...
        SceneEvent.LOAD_COMPLETE = 'SceneEvent.loadComplete';
        SceneEvent.UNLOAD_COMPLETE = 'SceneEvent.unloadComplete';
        SceneEvent.ARRIVE_COMPLETE = 'SceneEvent.arriveComplete';
        SceneEvent.LEAVE_COMPLETE = 'SceneEvent.leaveComplete';
        SceneEvent.ASCEND_COMPLETE = 'SceneEvent.ascendComplete';
        SceneEvent.DESCEND_COMPLETE = 'SceneEvent.descendComplete';
        return SceneEvent;
    }(Event));
...
(function (scn) {
    var SceneTransferInfo = (function () {
        function SceneTransferInfo(transferId, departurePath, destinationPath, message) {
            if (message === void 0) { message = null; }
...
(function (scn) {
    ...
    var SceneManager = (function (_super) {
        ...
        function SceneManager(name, rootSceneClass) {
            if (name === void 0) { name = ''; }
            if (rootSceneClass === void 0) { rootSceneClass = RootScene; }
            var _this = _super.call(this) || this;
            ...
            _this.name = name;
            _this.root = new rootSceneClass(_this);
        ...
        SceneManager.prototype.start = function (message) {
            if (message === void 0) { message = null; }
            Logger.verbose('----- scene manager start -----');
            this.goto('/', message);
        };
        SceneManager.prototype.goto = function (path, message) {
            if (message === void 0) { message = null; }
            ...
            if (newWaypoints.length > 0) {
                ...
                if (!isDestinationChanged) {
                    this.dispatchEvent(new scn.SceneManagerTransferEvent(scn.SceneManagerTransferEvent.TRANSFER_START, this, this.transferInfo));
                }
                this.checkState();
            }
        };
        ...
        SceneManager.prototype.addSceneAt = function (path) {
            var success = false;
        ...
        SceneManager.prototype.getParentSceneByPath = function (path) {
            var names = this.getSceneNamesByPath(path);
            names.pop();
            return this.getSceneBySceneNames(names);
        };
        SceneManager.prototype.getSceneBySceneNames = function (names) {
            var n = names.length;
            var scene = this.root;
            for (var i = 1; i < n; ++i) {
        ...
        SceneManager.prototype.dumpWaypoint = function (waypoints) {
        ...
        SceneManager.prototype.dumpAllPath = function () {
            Logger.info('----- scene all path -----');
            this._dumpAllPath(this.root);
        };
        SceneManager.prototype._dumpAllPath = function (parent) {
            var _this = this;
            var children = parent.getChildrenByName();
            Obj.each(children, function (name, child) {
                Logger.info(child.getPath());
                _this._dumpAllPath(child);
            });
        };
        SceneManager.prototype.checkState = function () {
            if (this.waypointIndex >= this.waypoints.length) {
                ...
                this.dispatchEvent(new scn.SceneManagerTransferEvent(scn.SceneManagerTransferEvent.TRANSFER_COMPLETE, this, this.transferInfo));
            ...
            if (this.currentScene) {
                ...
                var currentWaypointPath = currentWaypoint.getPath();
                this.currentScene = this.getSceneByPath(currentWaypointPath);
                if (!this.currentScene) {
                    this.dispatchEvent(new scn.SceneManagerRequireSceneEvent(scn.SceneManagerRequireSceneEvent.REQUIRE_SCENE, this, currentWaypointPath));
                    this.currentScene = this.getSceneByPath(currentWaypointPath);
                }
                if (!this.currentScene) {
...
(function (scn) {
    var Event = alm.event.Event;
    var SceneManagerTransferEvent = (function (_super) {
        __extends(SceneManagerTransferEvent, _super);
        function SceneManagerTransferEvent(eventType, eventTarget, transferInfo) {
            var _this = _super.call(this, eventType, eventTarget) || this;
            _this.transferInfo = transferInfo;
            return _this;
        }
        SceneManagerTransferEvent.prototype.clone = function () {
            return new SceneManagerTransferEvent(this.type, this.target, this.transferInfo);
        };
        SceneManagerTransferEvent.prototype.toString = function () {
            return '[SceneManagerTransferEvent] type = ' + this.type;
        };
        SceneManagerTransferEvent.TRANSFER_START = 'SceneManagerTransferEvent.transferStart';
        SceneManagerTransferEvent.TRANSFER_COMPLETE = 'SceneManagerTransferEvent.transferComplete';
        return SceneManagerTransferEvent;
    }(Event));
...
(function (scn) {
    var Event = alm.event.Event;
    var SceneManagerRequireSceneEvent = (function (_super) {
        __extends(SceneManagerRequireSceneEvent, _super);
        function SceneManagerRequireSceneEvent(eventType, eventTarget, scenePath) {
            var _this = _super.call(this, eventType, eventTarget) || this;
            _this.scenePath = scenePath;
            return _this;
        }
        SceneManagerRequireSceneEvent.prototype.clone = function () {
            return new SceneManagerRequireSceneEvent(this.type, this.target, this.scenePath);
        };
        SceneManagerRequireSceneEvent.prototype.toString = function () {
            return '[SceneManagerRequireSceneEvent] type = ' + this.type + ', scenePath = ' + this.scenePath;
        };
        SceneManagerRequireSceneEvent.REQUIRE_SCENE = 'SceneManagerRequireSceneEvent.requireScene';
        return SceneManagerRequireSceneEvent;
    }(Event));
