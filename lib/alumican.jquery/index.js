...
(function (alm) {
    ...
    (function (util) {
        ...
        var TweenCSS = (function () {
            ...
            TweenCSS.movePosition = function (target, property, from, to, duration, easing, execute) {
                if (duration === void 0) { duration = 500; }
                if (easing === void 0) { easing = Easing.easeOutQuart; }
                if (execute === void 0) { execute = true; }
                var o = { value: from };
            ...
            TweenCSS.moveLeft = function (target, from, to, duration, easing, execute) {
                if (duration === void 0) { duration = 500; }
                if (easing === void 0) { easing = Easing.easeOutQuart; }
                if (execute === void 0) { execute = true; }
                return TweenCSS.movePosition(target, 'left', from, to, duration, easing, execute);
            };
            TweenCSS.moveRight = function (target, from, to, duration, easing, execute) {
                if (duration === void 0) { duration = 500; }
                if (easing === void 0) { easing = Easing.easeOutQuart; }
                if (execute === void 0) { execute = true; }
                return TweenCSS.movePosition(target, 'right', from, to, duration, easing, execute);
            };
            TweenCSS.moveTop = function (target, from, to, duration, easing, execute) {
                if (duration === void 0) { duration = 500; }
                if (easing === void 0) { easing = Easing.easeOutQuart; }
                if (execute === void 0) { execute = true; }
                return TweenCSS.movePosition(target, 'top', from, to, duration, easing, execute);
            };
            TweenCSS.moveBottom = function (target, from, to, duration, easing, execute) {
                if (duration === void 0) { duration = 500; }
                if (easing === void 0) { easing = Easing.easeOutQuart; }
                if (execute === void 0) { execute = true; }
