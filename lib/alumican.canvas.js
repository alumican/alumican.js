    ...
    (function (canvas) {
        ...
        var BaseApp = (function (_super) {
            ...
            function BaseApp(canvasId, isAutoResizeEnabled) {
                ...
                _this.canvasTouchMoveHandler = function (event) {
                ...
                jQuery(window).on('mouseover', _this.mouseOverHandler);
                jQuery(window).on('mouseout', _this.mouseOutHandler);
                jQuery(window).on('mousedown', _this.mouseDownHandler);
                jQuery(window).on('mouseup', _this.mouseUpHandler);
                jQuery(window).on('mousemove', _this.mouseMoveHandler);
                jQuery(window).on('touchstart', _this.touchStartHandler);
                jQuery(window).on('touchend', _this.touchEndHandler);
                jQuery(window).on('touchcancel', _this.touchCancelHandler);
                jQuery(window).on('touchmove', _this.touchMoveHandler);
                jQuery(window).on('touchforcechange', _this.touchForceChangeHandler);
                jQuery(window).on('keydown', _this.keyDownHandler);
                jQuery(window).on('keyup', _this.keyUpHandler);
                _this.canvas.on('touchmove', _this.canvasTouchMoveHandler);
                requestAnimationFrame(_this.requestAnimationFrame);
                _this.onPlatformSetup.apply(_this, platformSetupOptions);
                _this.onSetup();
                if (_this.isAutoResizeEnabled) {
                    jQuery(window).on('resize', _this.resizeHandler);
