    ...
    (function (drawer) {
        ...
        (function (view_2) {
            ...
            var DrawerForeground = (function (_super) {
                ...
                function DrawerForeground(content) {
                ...
                DrawerForeground.prototype.moveLeft = function (target, from, to, duration, easing, execute) {
                ...
                DrawerForeground.prototype.moveRight = function (target, from, to, duration, easing, execute) {
                    if (duration === void 0) { duration = 0.5; }
                    if (easing === void 0) { easing = Easing.easeOutQuart; }
                    if (execute === void 0) { execute = true; }
    ...
    (function (drawer) {
        ...
        (function (view_3) {
            ...
            var DrawerContainer = (function (_super) {
                ...
                function DrawerContainer(content, drawerId) {
                ...
                DrawerContainer.prototype.implInitialize = function () {
                    ...
                    this.foreground = new view_3.DrawerForeground(this.content);
                    return view;
                };
...
(function (alm) {
    ...
    (function (drawer) {
        ...
        var Drawer = (function () {
            function Drawer(content, drawerId) {
                if (drawerId === void 0) { drawerId = 'drawer'; }
